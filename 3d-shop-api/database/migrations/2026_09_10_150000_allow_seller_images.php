...
{
    private const KINDS = ['deliverable', 'preview_image', 'thumbnail', 'seller_image'];
    ...
    {
        DB::table('product_files')->where('kind', 'seller_image')->delete();

        $this->replaceKindCheck(array_slice(self::KINDS, 0, 3));
    }
