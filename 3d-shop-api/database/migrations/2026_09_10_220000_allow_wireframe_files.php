...
{
    private const KINDS = ['deliverable', 'preview_image', 'thumbnail', 'seller_image', 'wireframe'];
    ...
    {
        DB::table('product_files')->where('kind', 'wireframe')->delete();

        $this->replaceKindCheck(array_slice(self::KINDS, 0, 4));
    }
